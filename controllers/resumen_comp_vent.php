...
class Resumen_comp_vent extends MX_Controller {
    ...
    public function get_compras_por_grupo($desde, $hasta, $bodega_id, $grupo_farm) {
        ...
        $join_cluase = array(
//            '0' => array('table' => 'billing_facturacompra fc', 'condition' => 'fc.codigoFacturaCompra=dfc.FacturaCompra_codigo and fc.estado>0 and fc.fechaCreacion >= ' . $desde . ' and fc.fechaCreacion <= ' . $hasta),
...
//        $where = array('fechaCreacion >=' => $desde, 'fechaCreacion <=' => $hasta, 'bodega_id' => $bodega_id);
