...
class servicio_emerg_hospit {
    ...
    public function get_fact_pago_efectivo_hospitalizados($fecha_desde, $fecha_hasta) {
        return $this->ci->liquidacion_all_servicios->get_totales_facturas_pago($fecha_desde, $fecha_hasta, $this->cod_hospitalizacion, $this->tipo_pago_efectivo, $this->tipo_comprobante, $this->cod_cliente_civil);
    }
    ...
    public function get_fact_pago_efectivo_emergencia($fecha_desde, $fecha_hasta) {
        return $this->ci->liquidacion_all_servicios->get_totales_facturas_pago($fecha_desde, $fecha_hasta, $this->cod_emergencia, $this->tipo_pago_efectivo, $this->tipo_comprobante, $this->cod_cliente_civil);
    }
    ...
    public function get_desglose_emergencia($fecha_desde, $fecha_hasta) {
        return $this->ci->liquidacion_all_servicios->get_valores_liquid_por_servicio($fecha_desde, $fecha_hasta, $this->cod_emergencia, $this->tipo_pago_efectivo, $this->tipo_comprobante);
    }
    ...
    public function get_desglose_hospitalizacion($fecha_desde, $fecha_hasta) {
        return $this->ci->liquidacion_all_servicios->get_valores_liquid_por_servicio($fecha_desde, $fecha_hasta, $this->cod_hospitalizacion, $this->tipo_pago_efectivo, $this->tipo_comprobante);
    }
