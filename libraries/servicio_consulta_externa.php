...
class Servicio_consulta_externa {
    ...
    public function get_fact_pago_efectivo_pacientes($fecha_desde, $fecha_hasta){
        return $this->ci->liquidacion_all_servicios->get_valores_liquid_por_servicio($fecha_desde, $fecha_hasta, $this->cod_cons_externa, $this->tipo_pago_efectivo, $this->tipo_comprobante);
    }
    ...
    public function get_fact_pago_efectivo_clientes($fecha_desde, $fecha_hasta) {
        return $this->ci->liquidacion_all_servicios->get_valores_liquid_por_servicio($fecha_desde, $fecha_hasta, $this->cod_serv_default, $this->tipo_pago_efectivo, $this->tipo_comprobante);
    }
