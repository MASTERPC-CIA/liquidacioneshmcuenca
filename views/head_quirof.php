...
echo '<strong>QUIROFANO - OPCIONES DE BUSQUEDA</strong>';
echo Close('div');

echo Open('form', array('action' => base_url('liquidacioneshmcuenca/honorarios/honorarios_med/get_list_quirof'), 'method' => 'post'));
