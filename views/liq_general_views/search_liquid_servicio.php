<?php
echo tagcontent('div','<strong style="font-size:20px;">LIQUIDACI&Oacute;N DEL SERVICIO</strong>',array('class'=>'col-md-12','style'=>'text-align:center;'));
echo lineBreak2(1, array('class'=>'clr'));
    echo Open('form', array('method'=>'post','action'=>  base_url().'liquidacioneshmcuenca/liquid_general/liquidacion_general/get_data_liquidacion','style'=>'margin-top:10px')); 
...
echo tagcontent('div', '', array('id'=>'res_liq_serv_out','class'=>'col-md-12'));
