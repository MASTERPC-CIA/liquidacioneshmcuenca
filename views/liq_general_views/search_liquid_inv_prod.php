<?php
echo tagcontent('div','<strong style="font-size:20px;">INVENTARIO DE PRODUCTOS</strong>',array('class'=>'col-md-12','style'=>'text-align:center;'));
echo lineBreak2(1, array('class'=>'clr'));
echo Open('form', array('method'=>'post','action'=>  base_url().'liquidacioneshmcuenca/liquid_general/liquidacion_general/get_inv_productos','style'=>'margin-top:10px')); 
    ...
    echo tagcontent('button', '<span class="glyphicon glyphicon-search"></span> Buscar', array('type'=>'submit','id'=>'ajaxformbtn','data-target'=>'res_inv_prod_out','class'=>'btn btn-primary btn-sm'));
echo Close('form');

echo tagcontent('div', '', array('id'=>'res_inv_prod_out','class'=>'col-md-12'));
