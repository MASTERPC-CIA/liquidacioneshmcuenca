...
echo '<strong>HOJA DE ALTA - OPCIONES DE BUSQUEDA</strong>';
echo Close('div');

echo Open('form', array('action' => base_url('liquidacioneshmcuenca/honorarios/honorarios_med/get_list_h_alta'), 'method' => 'post'));
