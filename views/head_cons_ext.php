...
echo '<strong>CONSULTA EXTERNA - OPCIONES DE BUSQUEDA</strong>';
echo Close('div');

echo Open('form', array('action' => base_url('liquidacioneshmcuenca/honorarios/honorarios_med/get_list_consulta'), 'method' => 'post'));
...
$clasesujeto = '';
$clasesujeto .= tagcontent('option', 'Planta', array('value' => 'M-P-001'));
$clasesujeto .= tagcontent('option', 'Ascrito', array('value' => 'M-A-001'));
echo Open('div', array('class' => 'col-md-4 form-group'));
$input = tagcontent('select', $clasesujeto, array('class' => 'form-control input-sm', 'name' => 'tipo', 'id' => 'tipo'));
echo tagcontent('div', $input, array('class' => 'form-group col-md-12'));
echo Close('div');
