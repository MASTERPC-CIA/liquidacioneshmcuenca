...
echo Open('table',array('class'=>'table table-striped table-condensed','border'=>'1','style'=>'font-size:'.get_settings('FONT_SIZE_FACT'),'width'=>'100%'));
    ...
    echo Open('tr');
        echo tagcontent('td', '<b>TOTAL SERVICIO '.$desg_hospit_credito['nombre_servicio'].':</b>', array('style'=>'text-align:right'));
        echo tagcontent('td', number_format($desg_hospit_credito['total_serv_iva_0'], get_settings('NUM_DECIMALES'), '.', ''), array('style'=>'text-align:right'));
        echo tagcontent('td', number_format($desg_hospit_credito['total_serv_otro_iva'], get_settings('NUM_DECIMALES'), '.', ''), array('style'=>'text-align:right'));
        echo tagcontent('td', number_format($desg_hospit_credito['total_serv_iva'], get_settings('NUM_DECIMALES'), '.', ''), array('style'=>'text-align:right'));
        echo tagcontent('td', number_format($desg_hospit_credito['total_servicio'], get_settings('NUM_DECIMALES'), '.', ''), array('style'=>'text-align:right'));
    echo Close('tr');
