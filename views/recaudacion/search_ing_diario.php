<?php
echo tagcontent('div','<strong style="font-size:20px;">INGRESOS DIARIOS</strong>',array('class'=>'col-md-12','style'=>'text-align:center;'));
echo lineBreak2(1, array('class'=>'clr'));
echo Open('form', array('method'=>'post','action'=>  base_url().'liquidacioneshmcuenca/recaudacion/liquid_recaudacion/get_ing_diario','style'=>'margin-top:10px')); 
